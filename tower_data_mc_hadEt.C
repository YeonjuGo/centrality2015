...
// ===============================================================================================
    ...
    TH1D* mc_pf_hadEt[5];
    TH1D* mc_rec_hadEt[5];
    TH1D* effi_pf_hadEt[5];// effi = data/mc
    TH1D* effi_rec_hadEt[5];// effi = data/mc
    for(int i=0; i<Ncut; i++)
    {
        data_pf_hadEt[i] = new TH1D(Form("data_pf_hadEt%d",i), ";pfTowers/hadEt;Normalized Events",100,0,100);
        data_pf_hadEt[i] -> SetMarkerStyle(20);
        data_pf_hadEt[i] -> SetMarkerSize(0.7);
        data_pf_hadEt[i] -> SetMarkerColor(21+i);
       ...
       // mc_pf_hadEt[i] -> SetMarkerSize(0.7);
        mc_pf_hadEt[i] -> SetMarkerColor(21+i); //marker color
        ...
        data_rec_hadEt[i] -> SetMarkerStyle(20);
        data_rec_hadEt[i] -> SetMarkerSize(0.7);
        data_rec_hadEt[i] -> SetMarkerColor(31+i);
       ...
       // mc_rec_hadEt[i] -> SetMarkerSize(0.7);
        mc_rec_hadEt[i] -> SetMarkerColor(31+i); //marker color
        mc_rec_hadEt[i] -> SetLineColor(31+i); //line color
        mc_rec_hadEt[i] -> SetLabelSize(0.03);
        
        effi_pf_hadEt[i] = new TH1D(Form("effi_pf_hadEt%d",i), ";pfTowers/hadEt;DATA/MC",100,0,100);
        effi_pf_hadEt[i] -> SetMarkerStyle(20);
        effi_pf_hadEt[i] -> SetMarkerSize(0.7);
        effi_pf_hadEt[i] -> SetMarkerColor(21+i);
        effi_pf_hadEt[i] -> SetLabelSize(0.03);
        effi_pf_hadEt[i] -> SetAxisRange(0.5,1.5,"Y");

        effi_rec_hadEt[i] = new TH1D(Form("effi_rec_hadEt%d",i), ";rechitTowers/hadEt;DATA/MC",100,0,100);
        effi_rec_hadEt[i] -> SetMarkerStyle(20);
        effi_rec_hadEt[i] -> SetMarkerSize(0.7);
        effi_rec_hadEt[i] -> SetMarkerColor(31+i);
        effi_rec_hadEt[i] -> SetLabelSize(0.03);
        effi_rec_hadEt[i] -> SetAxisRange(0.5,1.5,"Y");
...
//    datat_pfTower -> Draw("et >>+ data_pf_hadEt0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
//    data_pf_hadEt[0] = (TH1D*)gDirectory->Get("data_pf_hadEt0");
/*    datat_pfTower -> Draw("et >>+ data_pf_hadEt1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    data_pf_hadEt[1] = (TH1D*)gDirectory->Get("data_pf_hadEt1");
    datat_pfTower -> Draw("et >>+ data_pf_hadEt2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    data_pf_hadEt[2] = (TH1D*)gDirectory->Get("data_pf_hadEt2");
    datat_pfTower -> Draw("et >>+ data_pf_hadEt3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
  ...
  */  datat_pfTower -> Draw("hadEt >>+ data_pf_hadEt4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
    ...
    cout << "data_pf_hadEt finished"<< endl;

//    mct_pfTower -> Draw("et >>+ mc_pf_hadEt0");
//    mc_pf_hadEt[0] = (TH1D*)gDirectory->Get("mc_pf_hadEt0");
/*    mct_pfTower -> Draw("et >>+ mc_pf_hadEt1","pprimaryVertexFilter==1");
    mc_pf_hadEt[1] = (TH1D*)gDirectory->Get("mc_pf_hadEt1");
    mct_pfTower -> Draw("et >>+ mc_pf_hadEt2","phltPixelClusterShapeFilter==1");
    mc_pf_hadEt[2] = (TH1D*)gDirectory->Get("mc_pf_hadEt2");
    mct_pfTower -> Draw("et >>+ mc_pf_hadEt3","phfCoincFilter3==1");
 ...
 */   mct_pfTower -> Draw("hadEt >>+ mc_pf_hadEt4","pcollisionEventSelection==1");
    ...
    cout << "mc_pf_hadEt"<< endl;

//    datat_recTower -> Draw("et >>+ data_rec_hadEt0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
//    data_rec_hadEt[0] = (TH1D*)gDirectory->Get("data_rec_hadEt0");
/*    datat_recTower -> Draw("et >>+ data_rec_hadEt1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    data_rec_hadEt[1] = (TH1D*)gDirectory->Get("data_rec_hadEt1");
    datat_recTower -> Draw("et >>+ data_rec_hadEt2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    data_rec_hadEt[2] = (TH1D*)gDirectory->Get("data_rec_hadEt2");
    datat_recTower -> Draw("et >>+ data_rec_hadEt3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
...
//    mct_recTower -> Draw("et >>+ mc_rec_hadEt0");
//    mc_rec_hadEt[0] = (TH1D*)gDirectory->Get("mc_rec_hadEt0");
 /*   mct_recTower -> Draw("et >>+ mc_rec_hadEt1","pprimaryVertexFilter==1");
    mc_rec_hadEt[1] = (TH1D*)gDirectory->Get("mc_rec_hadEt1");
    mct_recTower -> Draw("et >>+ mc_rec_hadEt2","phltPixelClusterShapeFilter==1");
    mc_rec_hadEt[2] = (TH1D*)gDirectory->Get("mc_rec_hadEt2");
    mct_recTower -> Draw("et >>+ mc_rec_hadEt3","phfCoincFilter3==1");
  ...
  */  mct_recTower -> Draw("hadEt >>+ mc_rec_hadEt4","pcollisionEventSelection==1");
    ...
    //for(int i=0; i<Ncut; i++){
    int i=4;    
    data_pf_hadEt[i] -> Scale(1./data_pf_hadEt[i]->Integral("width"));
        data_rec_hadEt[i] -> Scale(1./data_rec_hadEt[i]->Integral("width"));
        mc_pf_hadEt[i] -> Scale(1./mc_pf_hadEt[i]->Integral("width"));
        mc_rec_hadEt[i] -> Scale(1./mc_rec_hadEt[i]->Integral("width"));
  /*    data_pf_hadEt[i] -> Scale(1./Npf_dataEntries);
        data_rec_hadEt[i] -> Scale(1./Nrec_dataEntries);
        mc_pf_hadEt[i] -> Scale(1./Npf_mcEntries);
        mc_rec_hadEt[i] -> Scale(1./Nrec_mcEntries);
*/  //  }
    effi_pf_hadEt[i] -> Divide(data_pf_hadEt[i],mc_pf_hadEt[i]);
    effi_rec_hadEt[i] -> Divide(data_rec_hadEt[i],mc_rec_hadEt[i]);
...
/*    mc_rec_hadEt[1] -> Draw("same ep");
  ...
  *///  mc_rec_hadEt[4] -> Draw("same ep");
    ...
    mc_pf_hadEt[4] -> Draw("same ehist");
    data_rec_hadEt[4] -> Draw("same ep");
    mc_rec_hadEt[4] -> Draw("same ehist");
    TLegend *leg = new TLegend(0.7,0.7,0.9,0.9);
    leg->SetFillColor(0);
    leg->SetTextFont(43);
    leg->SetTextSize(15);
    leg->AddEntry(data_pf_hadEt[4],"pfTower DATA","p");
    leg->AddEntry(mc_pf_hadEt[4],"pfTower MC","l");
    leg->AddEntry(data_rec_hadEt[4],"rechitTower DATA","p");
    leg->AddEntry(mc_rec_hadEt[4],"rechitTower MC","l");
    leg->Draw();
 
    TCanvas *c_compare_hadEt_effi = new TCanvas("c_compare_hadEt_effi", "c_compare_hadEt_effi", 400,200);
    effi_pf_hadEt[4] -> Draw("ep");
    effi_rec_hadEt[4] -> Draw("same ep");
    c_compare_hadEt_effi->SaveAs("pdf/tower_hadEt_effi.pdf");
    leg->Draw();

    c_compare_hadEt -> SaveAs("pdf/tower_hadEt.pdf");
    
    TCanvas *c_compare_hadEt_seperately = new TCanvas("c_compare_hadEt_seperately", "c_compare_hadEt_seperately", 1000,400);
    c_compare_hadEt_seperately -> Divide(2,1);
    c_compare_hadEt_seperately -> cd(1);
  //  c_compare_hadEt_seperately1 -> SetLogy();
    data_pf_hadEt[4] -> Draw("ep");
    mc_pf_hadEt[4] -> Draw("same ehist");
    leg -> Draw();

    c_compare_hadEt_seperately -> cd(2);
   // c_compare_hadEt_seperately2 -> SetLogy();
    data_rec_hadEt[4] -> Draw("ep");
    mc_rec_hadEt[4] -> Draw("same ehist");

    c_compare_hadEt_seperately -> SaveAs("pdf/tower_hadEt_sep.pdf");
