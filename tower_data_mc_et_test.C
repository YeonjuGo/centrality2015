...
// ===============================================================================================
    ...
    datat_pfTower -> Project("data_pf_et0","et",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
    cout << "122"<< endl;
/*    datat_pfTower -> Project("et >>+ data_pf_et1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    data_pf_et[1] = (TH1D*)gDirectory->Get("data_pf_et1");
    datat_pfTower -> Project("et >>+ data_pf_et2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    data_pf_et[2] = (TH1D*)gDirectory->Get("data_pf_et2");
    datat_pfTower -> Project("et >>+ data_pf_et3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    data_pf_et[3] = (TH1D*)gDirectory->Get("data_pf_et3");
  */  datat_pfTower -> Project("data_pf_et4","et",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
    mct_pfTower -> Project("mc_pf_et0","et");
/*    mct_pfTower -> Project("et >>+ mc_pf_et1","pprimaryVertexFilter==1");
    mc_pf_et[1] = (TH1D*)gDirectory->Get("mc_pf_et1");
    mct_pfTower -> Project("et >>+ mc_pf_et2","phltPixelClusterShapeFilter==1");
    mc_pf_et[2] = (TH1D*)gDirectory->Get("mc_pf_et2");
    mct_pfTower -> Project("et >>+ mc_pf_et3","phfCoincFilter3==1");
    mc_pf_et[3] = (TH1D*)gDirectory->Get("mc_pf_et3");
 */   mct_pfTower -> Project("mc_pf_et4","et","pcollisionEventSelection==1");

    datat_recTower -> Project("data_rec_et0","et",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
/*    datat_recTower -> Project("et >>+ data_rec_et1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    data_rec_et[1] = (TH1D*)gDirectory->Get("data_rec_et1");
    datat_recTower -> Project("et >>+ data_rec_et2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    data_rec_et[2] = (TH1D*)gDirectory->Get("data_rec_et2");
    datat_recTower -> Project("et >>+ data_rec_et3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    data_rec_et[3] = (TH1D*)gDirectory->Get("data_rec_et3");
  */  datat_recTower -> Project("data_rec_et4","et",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");

    mct_recTower -> Project("mc_rec_et0","et");
 /*   mct_recTower -> Project("et >>+ mc_rec_et1","pprimaryVertexFilter==1");
    mc_rec_et[1] = (TH1D*)gDirectory->Get("mc_rec_et1");
    mct_recTower -> Project("et >>+ mc_rec_et2","phltPixelClusterShapeFilter==1");
    mc_rec_et[2] = (TH1D*)gDirectory->Get("mc_rec_et2");
    mct_recTower -> Project("et >>+ mc_rec_et3","phfCoincFilter3==1");
    mc_rec_et[3] = (TH1D*)gDirectory->Get("mc_rec_et3");
  */  mct_recTower -> Project("mc_rec_et4","et","pcollisionEventSelection==1");
