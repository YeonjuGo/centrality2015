...
// ===============================================================================================
    ...
    TH1D* data_pf_emEt[5];
    TH1D* data_rec_emEt[5];
    TH1D* mc_pf_emEt[5];
    TH1D* mc_rec_emEt[5];
    TH1D* effi_pf_emEt[5];// effi = data/mc
    TH1D* effi_rec_emEt[5];// effi = data/mc
    for(int i=0; i<Ncut; i++)
    {
        data_pf_emEt[i] = new TH1D(Form("data_pf_emEt%d",i), ";pfTowers/emEt;Normalized Events",100,0,100);
        data_pf_emEt[i] -> SetMarkerStyle(20);
        data_pf_emEt[i] -> SetMarkerSize(0.7);
        data_pf_emEt[i] -> SetMarkerColor(21+i);
        data_pf_emEt[i] -> SetLabelSize(0.03);

        mc_pf_emEt[i] = new TH1D(Form("mc_pf_emEt%d",i), ";pfTowers/emEt;Normalized Events",100,0,100);
       // mc_pf_emEt[i] -> SetMarkerStyle(24+i);
       // mc_pf_emEt[i] -> SetMarkerSize(0.7);
        mc_pf_emEt[i] -> SetMarkerColor(21+i); //marker color
        mc_pf_emEt[i] -> SetLineColor(21+i); //line color
        mc_pf_emEt[i] -> SetLabelSize(0.03);
   
        data_rec_emEt[i] = new TH1D(Form("data_rec_emEt%d",i), ";rechitTowers/emEt;Normalized Events",100,0,100);
        data_rec_emEt[i] -> SetMarkerStyle(20);
        data_rec_emEt[i] -> SetMarkerSize(0.7);
        data_rec_emEt[i] -> SetMarkerColor(31+i);
        data_rec_emEt[i] -> SetLabelSize(0.03);

        mc_rec_emEt[i] = new TH1D(Form("mc_rec_emEt%d",i), ";rechitTowers/emEt;Normalized Events",100,0,100);
       // mc_rec_emEt[i] -> SetMarkerStyle(24+i);
       // mc_rec_emEt[i] -> SetMarkerSize(0.7);
        mc_rec_emEt[i] -> SetMarkerColor(31+i); //marker color
        mc_rec_emEt[i] -> SetLineColor(31+i); //line color
        mc_rec_emEt[i] -> SetLabelSize(0.03);
        
        effi_pf_emEt[i] = new TH1D(Form("effi_pf_emEt%d",i), ";pfTowers/emEt;DATA/MC",100,0,100);
        effi_pf_emEt[i] -> SetMarkerStyle(20);
        effi_pf_emEt[i] -> SetMarkerSize(0.7);
        effi_pf_emEt[i] -> SetMarkerColor(21+i);
        effi_pf_emEt[i] -> SetLabelSize(0.03);
        effi_pf_emEt[i] -> SetAxisRange(0.5,1.5,"Y");

        effi_rec_emEt[i] = new TH1D(Form("effi_rec_emEt%d",i), ";rechitTowers/emEt;DATA/MC",100,0,100);
        effi_rec_emEt[i] -> SetMarkerStyle(20);
        effi_rec_emEt[i] -> SetMarkerSize(0.7);
        effi_rec_emEt[i] -> SetMarkerColor(31+i);
        effi_rec_emEt[i] -> SetLabelSize(0.03);
        effi_rec_emEt[i] -> SetAxisRange(0.5,1.5,"Y");
...
//    datat_pfTower -> Draw("et >>+ data_pf_emEt0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
//    data_pf_emEt[0] = (TH1D*)gDirectory->Get("data_pf_emEt0");
/*    datat_pfTower -> Draw("et >>+ data_pf_emEt1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    data_pf_emEt[1] = (TH1D*)gDirectory->Get("data_pf_emEt1");
    datat_pfTower -> Draw("et >>+ data_pf_emEt2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    data_pf_emEt[2] = (TH1D*)gDirectory->Get("data_pf_emEt2");
    datat_pfTower -> Draw("et >>+ data_pf_emEt3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    data_pf_emEt[3] = (TH1D*)gDirectory->Get("data_pf_emEt3");
  */  datat_pfTower -> Draw("emEt >>+ data_pf_emEt4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
    data_pf_emEt[4] = (TH1D*)gDirectory->Get("data_pf_emEt4");
    cout << "data_pf_emEt finished"<< endl;

//    mct_pfTower -> Draw("et >>+ mc_pf_emEt0");
//    mc_pf_emEt[0] = (TH1D*)gDirectory->Get("mc_pf_emEt0");
/*    mct_pfTower -> Draw("et >>+ mc_pf_emEt1","pprimaryVertexFilter==1");
    mc_pf_emEt[1] = (TH1D*)gDirectory->Get("mc_pf_emEt1");
    mct_pfTower -> Draw("et >>+ mc_pf_emEt2","phltPixelClusterShapeFilter==1");
    mc_pf_emEt[2] = (TH1D*)gDirectory->Get("mc_pf_emEt2");
    mct_pfTower -> Draw("et >>+ mc_pf_emEt3","phfCoincFilter3==1");
    mc_pf_emEt[3] = (TH1D*)gDirectory->Get("mc_pf_emEt3");
 */   mct_pfTower -> Draw("emEt >>+ mc_pf_emEt4","pcollisionEventSelection==1");
    mc_pf_emEt[4] = (TH1D*)gDirectory->Get("mc_pf_emEt4");
    cout << "mc_pf_emEt"<< endl;

//    datat_recTower -> Draw("et >>+ data_rec_emEt0",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1");
//    data_rec_emEt[0] = (TH1D*)gDirectory->Get("data_rec_emEt0");
/*    datat_recTower -> Draw("et >>+ data_rec_emEt1",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pprimaryVertexFilter==1");
    data_rec_emEt[1] = (TH1D*)gDirectory->Get("data_rec_emEt1");
    datat_recTower -> Draw("et >>+ data_rec_emEt2",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phltPixelClusterShapeFilter==1");
    data_rec_emEt[2] = (TH1D*)gDirectory->Get("data_rec_emEt2");
    datat_recTower -> Draw("et >>+ data_rec_emEt3",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && phfCoincFilter3==1");
    data_rec_emEt[3] = (TH1D*)gDirectory->Get("data_rec_emEt3");
  */  datat_recTower -> Draw("emEt >>+ data_rec_emEt4",eventCut &&  "HLT_HIMinBiasHfOrBSC_v1==1 && pcollisionEventSelection==1");
    data_rec_emEt[4] = (TH1D*)gDirectory->Get("data_rec_emEt4");

//    mct_recTower -> Draw("et >>+ mc_rec_emEt0");
//    mc_rec_emEt[0] = (TH1D*)gDirectory->Get("mc_rec_emEt0");
 /*   mct_recTower -> Draw("et >>+ mc_rec_emEt1","pprimaryVertexFilter==1");
    mc_rec_emEt[1] = (TH1D*)gDirectory->Get("mc_rec_emEt1");
    mct_recTower -> Draw("et >>+ mc_rec_emEt2","phltPixelClusterShapeFilter==1");
    mc_rec_emEt[2] = (TH1D*)gDirectory->Get("mc_rec_emEt2");
    mct_recTower -> Draw("et >>+ mc_rec_emEt3","phfCoincFilter3==1");
    mc_rec_emEt[3] = (TH1D*)gDirectory->Get("mc_rec_emEt3");
  */  mct_recTower -> Draw("emEt >>+ mc_rec_emEt4","pcollisionEventSelection==1");
    mc_rec_emEt[4] = (TH1D*)gDirectory->Get("mc_rec_emEt4");

    //for(int i=0; i<Ncut; i++){
    int i=4;    
    data_pf_emEt[i] -> Scale(1./data_pf_emEt[i]->Integral("width"));
        data_rec_emEt[i] -> Scale(1./data_rec_emEt[i]->Integral("width"));
        mc_pf_emEt[i] -> Scale(1./mc_pf_emEt[i]->Integral("width"));
        mc_rec_emEt[i] -> Scale(1./mc_rec_emEt[i]->Integral("width"));
  /*    data_pf_emEt[i] -> Scale(1./Npf_dataEntries);
        data_rec_emEt[i] -> Scale(1./Nrec_dataEntries);
        mc_pf_emEt[i] -> Scale(1./Npf_mcEntries);
        mc_rec_emEt[i] -> Scale(1./Nrec_mcEntries);
*/  //  }
    effi_pf_emEt[i] -> Divide(data_pf_emEt[i],mc_pf_emEt[i]);
    effi_rec_emEt[i] -> Divide(data_rec_emEt[i],mc_rec_emEt[i]);
...
/*
    TCanvas *c_data_emEt = new TCanvas("c_data_emEt", "c_data_emEt", 800,400);
    c_data_emEt -> Divide(2,1,0);
    c_data_emEt -> cd(1);
    data_pf_emEt[0] -> Draw("ep");
    data_pf_emEt[1] -> Draw("same ep");
    data_pf_emEt[2] -> Draw("same ep");
    data_pf_emEt[3] -> Draw("same ep");
    data_pf_emEt[4] -> Draw("same ep");
    
    c_data_emEt -> cd(2);
    data_rec_emEt[0] -> Draw("ep");
    data_rec_emEt[1] -> Draw("same ep");
    data_rec_emEt[2] -> Draw("same ep");
    data_rec_emEt[3] -> Draw("same ep");
    data_rec_emEt[4] -> Draw("same ep");
 */
    TCanvas *c_mc_emEt = new TCanvas("c_mc_emEt", "c_mc_emEt", 800,400);
    c_mc_emEt -> Divide(2,1,0);
    c_mc_emEt -> cd(1);
//    mc_pf_emEt[0] -> Draw("ep");
/*    mc_pf_emEt[1] -> Draw("same ep");
    mc_pf_emEt[2] -> Draw("same ep");
    mc_pf_emEt[3] -> Draw("same ep");
 */ //  mc_pf_emEt[4] -> Draw("same ep");
    
    c_mc_emEt -> cd(2);
 //   mc_rec_emEt[0] -> Draw("ep");
/*    mc_rec_emEt[1] -> Draw("same ep");
    mc_rec_emEt[2] -> Draw("same ep");
    mc_rec_emEt[3] -> Draw("same ep");
  *///  mc_rec_emEt[4] -> Draw("same ep");
    
    TCanvas *c_compare_emEt = new TCanvas("c_compare_emEt", "c_compare_emEt", 400,400);
    c_compare_emEt -> SetLogy();

    data_pf_emEt[4] -> Draw("ep");
    mc_pf_emEt[4] -> Draw("same ehist");
    data_rec_emEt[4] -> Draw("same ep");
    mc_rec_emEt[4] -> Draw("same ehist");
    TLegend *leg = new TLegend(0.7,0.7,0.9,0.9);
    leg->SetFillColor(0);
    leg->SetTextFont(43);
    leg->SetTextSize(15);
    leg->AddEntry(data_pf_emEt[4],"pfTower DATA","p");
    leg->AddEntry(mc_pf_emEt[4],"pfTower MC","l");
    leg->AddEntry(data_rec_emEt[4],"rechitTower DATA","p");
    leg->AddEntry(mc_rec_emEt[4],"rechitTower MC","l");
    leg->Draw();
 
    TCanvas *c_compare_emEt_effi = new TCanvas("c_compare_emEt_effi", "c_compare_emEt_effi", 400,200);
    effi_pf_emEt[4] -> Draw("ep");
    effi_rec_emEt[4] -> Draw("same ep");
    c_compare_emEt_effi->SaveAs("pdf/tower_emEt_effi.pdf");
    leg->Draw();

    c_compare_emEt -> SaveAs("pdf/tower_emEt.pdf");
    
    TCanvas *c_compare_emEt_seperately = new TCanvas("c_compare_emEt_seperately", "c_compare_emEt_seperately", 1000,400);
    c_compare_emEt_seperately -> Divide(2,1);
    c_compare_emEt_seperately -> cd(1);
  //  c_compare_emEt_seperately1 -> SetLogy();
    data_pf_emEt[4] -> Draw("ep");
    mc_pf_emEt[4] -> Draw("same ehist");
    leg -> Draw();

    c_compare_emEt_seperately -> cd(2);
   // c_compare_emEt_seperately2 -> SetLogy();
    data_rec_emEt[4] -> Draw("ep");
    mc_rec_emEt[4] -> Draw("same ehist");

    c_compare_emEt_seperately -> SaveAs("pdf/tower_emEt_sep.pdf");
